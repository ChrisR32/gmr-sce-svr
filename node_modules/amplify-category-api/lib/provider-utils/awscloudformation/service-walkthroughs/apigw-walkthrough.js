...
async function updateWalkthrough(context, defaultValuesFilename) {
    ...
    if (updateApi.resourceName === 'AdminQueries') {
        context.print.warning(`The Admin Queries API is maintained through the Auth category and should be updated using 'amplify update auth' command`);
        process.exit(0);
    }
    ...
    const questions = [
        {
            ...
            validate: value => rest_api_path_utils_1.validatePathName(value, answers.paths),
        },
        {
            name: 'functionType',
            type: 'list',
