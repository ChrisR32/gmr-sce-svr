...
async function initEnv(context) {
    ...
    const { resourcesToBeCreated, resourcesToBeDeleted, resourcesToBeUpdated } = await amplify.getResourceStatus(constants_1.category);
    ...
    const functionTasks = tasks.map(functionResource => {
        ...
        return async () => {
            ...
            context.amplify.saveEnvResourceParameters(context, constants_1.category, resourceName, config);
        };
    });
