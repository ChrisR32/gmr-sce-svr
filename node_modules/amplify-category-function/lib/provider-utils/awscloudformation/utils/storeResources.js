...
exports.createLayerArtifacts = (context, parameters) => {
    ...
    createParametersFile(context, {}, parameters.layerName, constants_1.parametersFileName);
...
function createParametersFile(context, parameters, resourceName, parametersFileName) {
    const parametersFilePath = path_1.default.join(context.amplify.pathManager.getBackendDirPath(), constants_2.category, resourceName, parametersFileName);
